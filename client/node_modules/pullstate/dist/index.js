'use strict';var isEqual=require('fast-deep-equal/es6'),React=require('react'),produce=require('immer');function useStoreState(store, getSubState, deps) {
...
exports.EPostActionContext=void 0;
...
further looping. Fix in your cacheBreakHook() is needed.`);
    ...
    const updateCached = (args, updater, options) => {
        ...
        if (cache.results.hasOwnProperty(key) && !cache.results[key][2].error) {
            ...
            const newResult = {
                payload: produce(currentCached, (s) => updater(s, currentCached)),
                error: false,
...
}exports.EAsyncActionInjectType=void 0;
